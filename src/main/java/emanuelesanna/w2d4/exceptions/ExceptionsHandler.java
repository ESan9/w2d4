package emanuelesanna.w2d4.exceptions;

import emanuelesanna.w2d4.payloads.ErrorWithListDTO;
import emanuelesanna.w2d4.payloads.ErrorsDTO;
...
public class ExceptionsHandler {
    ...
    // CORREZIONE: Intercetta solo ValidationException per risolvere l'ambiguità con handleBadRequest
    @ExceptionHandler(ValidationException.class) // Tra le parentesi indico quale eccezione dovrà gestire questo metodo
